...
public class CommonConfigs {
    ...
    public static ModConfigSpec.BooleanValue sdlinkCompat = builder
    ...
    public static ModConfigSpec.BooleanValue mohistCompat = builder
            .comment("""
    ...
    public static ModConfigSpec.ConfigValue<List<String>> ignore = builder
            .comment("TsukiChatは、以下の接頭辞から始まるメッセージのローマ字変換や日本語変換を行いません。\n" +
                    "ただし、マークダウンの変換は行われます。")
            .define("ignore", List.of("#", ";"));
    public static ModConfigSpec.ConfigValue<List<String>> ignoreCompletely = builder
            .comment("TsukiChatは、以下の接頭辞から始まるメッセージについて、一切の変換を行いません。")
            .define("ignore_completely", List.of(":", "./"));
    public static ModConfigSpec.ConfigValue<List<String>> ignoreMessages = builder
            .comment("メッセージが以下のリストのいずれかと一致する場合、一切の変換を行いません。")
            .define("ignore_messages", List.of(
                    "afk",
                    "bad",
                    "brb",
                    "btw",
    ...
    public static ModConfigSpec.ConfigValue<List<String>> serverDictionary = builder
            .comment("サーバー辞書。ここに登録された単語は、すべてのプレイヤーのメッセージに対して適用されます。\n" +
                    "キーと値は、タブ文字\\tで区切ってください。")
            .define("server_dictionary", List.of(
                    "TsukiChat\tTsukiChat",
                    "Minecraft\tMinecraft",
                    "Forge\tForge",
                    "Fabric\tFabric",
    ...
    public static final ModConfigSpec.ConfigValue<List<String>> forceGlobal = builder
            .comment("TsukiChatは、以下の接頭辞から始まるメッセージを強制的にグローバルチャットとして扱います。\n" +
                    "コンフィグdefault_team_msgが無効の場合は機能しません。")
            .define("force_global", List.of("!"));
